...
# if the value is 1 it essentially doubles
# 1 -> 2
# 2 -> 4
# 4 -> 8

# after each iteration we add the value of the current node
# before doubling it basically
...
class LinkedList:
    ...
    # accumulation method
    # computed value is multiplied by 2 and then we add the current value

    # this leads to this representation
    # 1 -> 1 -> 0 = 1 becomes 2 + 1 = 3, 3 becomes 6 + 0 = 6
